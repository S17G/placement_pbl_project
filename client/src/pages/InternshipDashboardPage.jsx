            ...
            {isLoading ? (
              ...
              internshipRecords.map((record) => (
                <tr key={record._id || record.id} className="border-t border-slate-700 text-slate-200">
                  <td className="px-4 py-3">{record.company_name || record.company || '-'}</td>
                  ...
                  <td className="px-4 py-3">{record.ctc || '-'}</td>
                  <td className="px-4 py-3">{record.stipend || record.package || '-'}</td>
